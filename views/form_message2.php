...
if (isSet($_POST['message'])) {
		if (isSet($_POST['message']) && $_POST['message'] != '') {
			...
			if ($q) {
				...
				mysql_query("INSERT INTO tbl_notification  VALUES ('', '$message', 'message','pending','$username')") or die(mysql_error());
	
		    echo "<script ='text/javascript'>";
			echo "alert('Message Sent!');";
			echo "window.location.href = '../admin/message.php';";
			echo "</script/>";
        	...
        	echo "window.location.href = '../admin/message.php';";
        	echo "</script/>";
				http_redirect('../admin/message.php', [], TRUE);
		}
	}
