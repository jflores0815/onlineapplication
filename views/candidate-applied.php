        ...
        <div class="header-top">
            <div class="container">
                ...
                <div class="ht-left">
                       ...
                       <a class="mail-service">&nbsp; &nbsp; Candidate Applied Jobs</a>
                 ...
                 <br>
                   ...
                   <div class="widget-content nopadding">
                      <table class="table table-bordered data-table">
        	             ...
        	             <thead>
					    <tr>
                        <th><center>List of Applied Jobs</center></th>
...
$query="SELECT * FROM candidate_resume a, job_ads b, tbl_candidates c WHERE (a.status = '1' OR a.status = '2' OR a.status = '3' OR a.status = '4') AND (b.j_id = a.job_id) AND (c.username = '$username' AND c.id = a.candidate_id)  ORDER BY a.date_submit DESC ";
...
a:link {
    color:#FFFFFF;
                        ...
                        <center>
                        <br>
                   	 <form action="candidate-view-applied.php?id=<?php echo $row['j_id']; ?>" method="POST" >
