        ...
        <div class="header-top">
            <div class="container">
                ...
                <div class="ht-left">
                       ...
                       <a class="mail-service">&nbsp; &nbsp; Admin for Requirements Candidates</a>
                 ...
                 <br>
                   ...
                   <div class="widget-content nopadding">
                      <table class="table table-bordered data-table">
        	             ...
        	             <thead>
					    <tr>
                        <th><center>List of for Requirements Candidates</center></th>
...
$query="SELECT * FROM candidate_resume a, job_ads b WHERE a.status = 3 AND b.j_id = a.job_id ORDER BY a.date_submit DESC ";
...
a:link {
    color:#FFFFFF;
                        ...
                        <center>
                         ...
                         <button style="width: 170px;" id="reject3" class="btn btn-warning" data-toggle="modal" data-target="#hireCandidate<?php echo $row['c_id'] ?>"> Hire Candidate </button>
                         ...
                         <button style="width: 170px;" id="reject3" class="btn btn-danger" data-toggle="modal" data-target="#rejectCandidate<?php echo $row['c_id'] ?>"> Reject Candidate </button>
    ...
    <div class="modal fade" id="hireCandidate<?php echo $row['c_id'] ?>"  role="dialog" >
...
<div class="modal-dialog" role="document">
  ...
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h5 class="modal-title" id="viewOrderedItemsLabel"><center><b>Hire Candidate</b></center></h5>
...
<center>
      <h6>Click approve to hire this candidate</h6>
        <br/>
      <form method="post" action="hired.php"> 

          <input type="hidden" name="hired" value="<?php echo $row['c_id'] ?>"/>
...
<center>
      <h6>Are you sure you want to reject this candidate?</h6>
        <br/>
      <form method="post" action="reject3.php"> 

          <input type="hidden" name="reject3" value="<?php echo $row['c_id'] ?>"/>
