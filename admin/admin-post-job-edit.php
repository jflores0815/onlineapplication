...
<head>
    ...
    <title>Admin | Edit Job Ads</title>
                    ...
                    <div class="login-form">
                     ...
                     <?php
                            ...
                            <div class="group-input">
                                ...
                                <input type="text" name="position" class="" placeholder="Enter Job Title" value="<?php echo $row['position']; ?>" required />
                            </div>

                            <div class="group-input">
                                <label for="location">Work Location</label>
                                <input type="text" name="location" class="" placeholder="Enter Work Location" value="<?php echo $row['location']; ?>" required />
                            </div>

                            <div class="group-input">
                                <label for="salary">Salary</label>
                                <input type="text" name="salary" class="" placeholder="Enter Salary" value="<?php echo $row['salary']; ?>" required />
                            </div>

                            <div class="group-input">
                                <label for="description">Job Description</label>
                                <textarea name="description" maxlength="100000" style="resize: none; width: 100%; height: 250px;" placeholder="Description" required> <?php echo $row['description']; ?> </textarea>
                            </div>

                            <div class="group-input">
                                <label for="qualification">Job Qualification</label>
                                <textarea name="qualification" maxlength="100000" style="resize: none; width: 100%; height: 250px;" placeholder="Qualification" required> <?php echo $row['qualification']; ?> </textarea>
                            </div>
                            ...
                            <button type="submit" class="site-btn login-btn" name="add" onclick="return personalInfo();">Save</button>
                            </div>
                            
                        </form>

                        <a href="admin-view-job.php"><button type="submit" class="btn btn-block" name="Cancel">Cancel</button></a>
